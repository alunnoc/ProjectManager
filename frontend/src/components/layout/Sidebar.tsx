...
import { LayoutDashboard, Calendar, Settings, FolderKanban, Plus, Trash2, X, ClipboardList, Pencil, BookOpen, StickyNote } from "lucide-react";
...
const navItems = [
  ...
  { to: "notes", label: "Appunti", icon: StickyNote },
